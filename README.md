...
Prior to implementing the face mask detection system, we conducted a thorough data analysis to prepare and train a model using our dataset. This crucial step involved assessing the validation accuracy and uncovering underlying patterns within the data. New dataset: https://drive.google.com/drive/folders/1ybiBBzVribn_p3Uk9HIFBTwGwSgJCPlu?usp=sharing
